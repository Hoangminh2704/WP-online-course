...
<body class="<?= htmlspecialchars($bodyClass) ?>">
    ...
    <nav class="home-nav" aria-label="Điều hướng chính">
        <div class="home-nav__inner">
            ...
            <div class="home-nav__menu">
                <a class="home-nav__link<?= $navActive === 'home' ? ' home-nav__link--active' : '' ?>" href="<?= htmlspecialchars(BASE_URL) ?>/">Home</a>
                <a class="home-nav__link<?= $navActive === 'courses' ? ' home-nav__link--active' : '' ?>" href="<?= htmlspecialchars(BASE_URL) ?>/courses">Courses</a>
                <a class="home-nav__link<?= $navActive === 'contact' ? ' home-nav__link--active' : '' ?>" href="<?= htmlspecialchars(BASE_URL) ?>/contact">Contact</a>
            </div>
            <div class="home-nav__search-wrap">
                <div class="home-nav__search">
                    ...
                    <input id="nav-search-q" class="home-nav__search-input" type="search" name="q" autocomplete="off" placeholder="Search courses…" maxlength="120"/>
                    <div id="nav-search-results" class="home-nav__search-results" hidden role="listbox" aria-label="Search suggestions"></div>
                </div>
            </div>
    ...
    <script>window.__BASE_URL__ = <?= json_encode(BASE_URL, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;</script>
